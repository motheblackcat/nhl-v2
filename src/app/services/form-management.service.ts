...
export class FormManagementService {
  ...
  saveForm(name: string, form: Object) {
    const formObject = {};
    formObject[name] = form as CharObject;

    // this.updateEffects();
    this.store.set('mainForm', formObject);

    console.log(formObject);

    /** TODO: For multi-persona the whole persona array will be replaced
     * Get currentPersona in all personas to the sheet
     * this.personas.find(currentPersona).sheet = { ...this.currentPersona.sheet, formObject };
